...
| [Settings Control Plane](./settings-control.md) | Single active draft, atomic publication, immutable history, field-level reversal, and post-commit cache invalidation | Filled |
