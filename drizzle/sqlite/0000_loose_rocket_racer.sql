...
--> statement-breakpoint
CREATE INDEX `render_styles_enabled_idx` ON `render_styles` (`enabled`);--> statement-breakpoint
CREATE UNIQUE INDEX `render_styles_css_class_idx` ON `render_styles` (`css_class`);--> statement-breakpoint
CREATE TABLE `runs` (
	`id` text PRIMARY KEY DEFAULT (lower(hex(randomblob(16)))) NOT NULL,
