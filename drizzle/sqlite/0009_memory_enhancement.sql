ALTER TABLE `user_memories` ADD `disclosure` text;--> statement-breakpoint
ALTER TABLE `user_memories` ADD `priority` integer DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE `user_memories` ADD `last_accessed_at` integer;--> statement-breakpoint
