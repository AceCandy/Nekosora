...
async function main(): Promise<void> {
  ...
  try {
    ...
    const catalogPath = "@/lib/jobs/catalog";
    const queueModule = await import(queuePath) as typeof import("@/lib/infra/queue");
    const { FILE_PROCESS_QUEUE } = await import(catalogPath) as typeof import("@/lib/jobs/catalog");
