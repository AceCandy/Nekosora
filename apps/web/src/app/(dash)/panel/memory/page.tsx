...
import { Trash2, BrainCircuit, Eraser } from "lucide-react";
import { clsx } from "clsx";
import { Button } from "@/shared/ui/Button";
import { PageHeader } from "@/shared/components/PageHeader";
import MemoryAddDialog from "@/features/panel/memory/MemoryAddDialog";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-end">
        <MemoryAddDialog action={async (formData: FormData) => {
          "use server";
          await addMemory(
            user.id,
            formData.get("scope") as MemoryScope,
