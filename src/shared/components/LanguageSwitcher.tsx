  ...
  return (
    <div className={clsx("relative inline-flex items-center", className)}>
      ...
      <select
        ...
        className="appearance-none bg-transparent text-sm font-medium text-neutral-600 hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-neutral-100 cursor-pointer disabled:opacity-50 pr-1"
      >
