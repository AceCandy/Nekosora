  ...
  return (
    <div className="flex-1 flex flex-col min-w-0 h-full p-6 md:p-8">
      <div className="shrink-0 mb-6">
        <h1 className="text-ui-title font-bold tracking-tight text-neutral-900 dark:text-white">{t("title")}</h1>
        <p className="text-ui-caption text-neutral-450 dark:text-neutral-500 mt-1">{t("subtitle")}</p>
      </div>
