...
export function DateRangePicker({ range, start, end, onChange }: DateRangePickerProps) {
  ...
  return (
    <div className="flex flex-col gap-1">
      <span className="text-[11px] text-neutral-400 dark:text-neutral-500">{t("filters.range")}</span>
      ...
      {isCustom && (
        <div className="flex items-center gap-1.5 mt-0.5">
          <input
            ...
            className="px-1.5 py-1 text-[11px] rounded border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-[#12141a] text-neutral-700 dark:text-neutral-300"
          />
