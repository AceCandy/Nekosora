...
export default async function BasicSettingsSection() {
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div>
        <h2 className="text-ui-title font-semibold text-neutral-900 dark:text-white">{t("basicTitle")}</h2>
      ...
      <form action={saveUA} className="rounded-lg border border-neutral-200 bg-white dark:border-neutral-800 dark:bg-[#12141a] p-5 space-y-3">
        <div className="space-y-1">
          <label className="text-ui-caption font-medium text-neutral-500">{t("chatUaLabel")}</label>
          <input
            name="chat_ua"
        ...
        <div className="space-y-1">
          <label className="text-ui-caption font-medium text-neutral-500">{t("gatewayUaLabel")}</label>
          <input
            name="gateway_ua"
